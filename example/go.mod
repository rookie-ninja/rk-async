module github.com/rookie-ninja/rk-async/example
...
require (
	...
	github.com/rookie-ninja/rk-db/mysql v1.2.21 // indirect
...
replace (
	...
	github.com/rookie-ninja/rk-async/database/mysql => ../database/mysql
)
