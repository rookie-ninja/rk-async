module github.com/rookie-ninja/rk-async/database/postgres
...
require (
	...
	github.com/rookie-ninja/rk-db/postgres v1.2.18
...
require (
	...
	github.com/rookie-ninja/rk-entry/v2 v2.2.17 // indirect
